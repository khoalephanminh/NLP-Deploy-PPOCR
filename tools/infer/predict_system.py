...
class TextSystem(object):
    ...
    def adjust_left_side(self, dt_boxes, offset):
        adjusted_boxes = []
        for box in dt_boxes:
            # Increase the x-coordinate of the first and fourth points
            box[0][0] += offset
            box[3][0] += offset
    ...
    def __call__(self, img, cls=True, slice={}):
        ...
        dt_boxes = self.adjust_left_side(dt_boxes, offset=3)
        ...
        for bno in range(len(dt_boxes)):
            ...
            if self.args.det_box_type == "quad":
                ...
                # cv2.imwrite(f'./xxx/{cnt}.jpg', img_crop)
            else:
